...
export default function FilterModal({
  ...
  return (
    ...
    >
      <DialogContent className="w-72 bg-white rounded-xl">
        <DialogHeader>
          {/* Header */}
          <View className="flex-row items-center justify-between px-5 pt-6 pb-3 bg-white border-b border-gray-300">
        ...
        <View className="px-5 pb-8 pt-4 bg-white border-t border-gray-100">
          <Button
            onPress={handleApply}
            className="bg-blue-600 rounded-2xl w-full items-center"
            style={{
              shadowColor: "#2563EB",
