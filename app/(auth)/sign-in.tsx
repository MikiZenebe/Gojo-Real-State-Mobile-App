    ...
    return (
      <View className="flex-1 justify-center items-center bg-white dark:bg-background px-6">
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
          className="w-full bg-blue-600 py-4 rounded-xl items-center mb-4 dark:bg-blue-500"
        >
          {isLoading ? (
    ...
    >
      <View className="flex-1 justify-center px-6 py-12">
        ...
        <Image
          ...
          resizeMode="contain"
        />
        <Text className="text-3xl font-bold text-gray-800 mb-2 dark:text-foreground">
          Welcome back
        </Text>
        <Text className="text-gray-500 mb-8 dark:text-muted-foreground">Sign in to your account</Text>
        ...
        <View className="flex-row justify-center">
          <Text className="text-gray-500 dark:text-muted-foreground">Don&apos;t have an account? </Text>
          <Link href="/sign-up">
